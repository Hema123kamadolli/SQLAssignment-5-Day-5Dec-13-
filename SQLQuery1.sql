...
insert into bank.Customer(CId,CName,CEmail,Contact) values ('1','Vikas','vikas@email.com',' 9902468515')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('2','Rajesh','rajesh@email.com','89 36128945')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('3','Chandana','chandana@email.com','8978456878')